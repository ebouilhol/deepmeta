...
# Paramètres à choisir manuellement en fonction du type d'image que l'on veut construire :
taille_min_poumon = 150
taille_min_meta = 0*255
taille_max_meta = 35*255
possibilite = [6, 8, 10, 12, 14, 16]  # nbr de métastases possible à mettre dans une slice de poumons.

# Path :
path_full_meta = os.path.join(PATH_Synth, "Full_Meta/")
...
path_result_souris = os.path.join(PATH_Synth, "Nouvelles_Images/"+name_souris)
