...
def qualite_model(num, path_model_seg, time, wei=None):
    ...
    path_souris_annoter = "/home/achauviere/Bureau/DATA/Souris_Test/Masque_Poumons/masque_"+str(num)+"/"
...
for i in range(len(a)):
    ...
    poumon_sain = utils.concat_data(utils.concat_data(utils.concat_data(utils.concat_data(utils.concat_data(a2, b2), c), d), e), f)
