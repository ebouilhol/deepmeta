...
a = utils.give_img(path_lacz, 'm2PL_day6.tif', 34,107)
b = utils.give_img(path_lacz, 'NoP_day19.tif', 15,101)
...
poumon_sain = utils.conc3D(utils.conc3D(utils.conc3D(utils.conc3D(utils.conc3D(a,b),c),d),e),f)
